...
<%-- 						<td>${todo.completionDate}</td>
 --%>					<td><a type="button" class="btn btn-warning" href="/deleteTodo?id=${todo.id}">Delete</a></td>
					...
					<%-- 	<td><form:form action="editRegions" method="post" style="display:inline-block;">                             
                              <input type="hidden" value="${region.regionheadId}" name="id"/>
                     		  <input class="btn btn-primary btn-xs" type="submit" name="edit" value="Edit"/> 
                     		 </form:form></td>
						<td><form:form action="deleteRegions" method="post" style="display:inline-block;">                             
                              <input type="hidden" value="${region.regionheadId}" name="id"/>
                     		  <input class="btn btn-primary btn-xs" type="submit" name="delete" value="Delete"/> 
                     		 </form:form></td> --%>
